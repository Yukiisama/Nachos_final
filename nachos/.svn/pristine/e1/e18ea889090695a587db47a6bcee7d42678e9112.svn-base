...
#define SC_SemaphoreInit   19
#define SC_SemaphoreP      20
#define SC_SemaphoreV      21
#define SC_ForkExec        22
#define SC_BonusExit       23 
#endif // CHANGED
...
sem_t Semaphore_P(int id);
sem_t Semaphore_V(int id);
/****************************************FORK***********************************/
int ForkExec(const char *s);
void BonusExit (int status);
#endif // CHANGED
